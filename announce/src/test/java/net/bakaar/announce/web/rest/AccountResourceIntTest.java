package net.bakaar.announce.web.rest;

import net.bakaar.announce.config.Constants;
import net.bakaar.announce.AnnounceApp;
import net.bakaar.announce.domain.Authority;
import net.bakaar.announce.domain.PersistentToken;
import net.bakaar.announce.domain.User;
import net.bakaar.announce.repository.AuthorityRepository;
import net.bakaar.announce.repository.PersistentTokenRepository;
import net.bakaar.announce.repository.UserRepository;
import net.bakaar.announce.security.AuthoritiesConstants;
import net.bakaar.announce.service.MailService;
import net.bakaar.announce.service.dto.UserDTO;
import net.bakaar.announce.web.rest.errors.ExceptionTranslator;
import net.bakaar.announce.web.rest.vm.KeyAndPasswordVM;
import net.bakaar.announce.web.rest.vm.ManagedUserVM;
import net.bakaar.announce.service.UserService;
...
@SpringBootTest(classes = AnnounceApp.class)
