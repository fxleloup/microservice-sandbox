package net.bakaar.announce.repository;

import net.bakaar.announce.AnnounceApp;
import net.bakaar.announce.config.Constants;
import net.bakaar.announce.config.audit.AuditEventConverter;
import net.bakaar.announce.domain.PersistentAuditEvent;
...
import static net.bakaar.announce.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
